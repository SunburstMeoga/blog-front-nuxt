<template>
  <div class="sports-news-area">
    <div :class="[
      ...
      <h3 class="title">運動 News</h3>
    </div>
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <divide-card :class="[darkClass && 'item' in darkClass ? darkClass.item : '']" stype="col"
          :datas="sportNews[0]" />
      </div>
      <div class="col-lg-6 col-md-6">
        <div class="trending-sidebar-slider">
          <span @click="sportSliderPrev" class="prev slick-arrow d-md-block d-none"><i
          ...
          <span @click="sportSliderNext" class="next slick-arrow d-md-block d-none"><i
